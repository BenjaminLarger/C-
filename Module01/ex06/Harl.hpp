...
# define PARAM "Enter only one complain as parameter : DEBUG, INFO, WARNING, ERROR"
# define COMP "You can only enter one of those complains : DEBUG, INFO, WARNING, ERROR"
