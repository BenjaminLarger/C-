...
/*   Updated: 2024/06/10 19:24:06 by blarger          ###   ########.fr       */
/*                                                                            */
/******************************************************************************/
...
/* SETTER */
void	ClapTrap::setName(std::string newName) {this->name = newName;}
void	ClapTrap::setPoints(unsigned int newPoints) {this->points = newPoints;}
void	ClapTrap::setEnergyPoints(unsigned int newEnergyPoints) {this->energyPoints = newEnergyPoints;}
void	ClapTrap::setAttackDamage(unsigned int newAttackDamage) {this->attackDamage = newAttackDamage;}